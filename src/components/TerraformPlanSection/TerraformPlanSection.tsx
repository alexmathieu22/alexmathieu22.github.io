...
const TerraformPlanSection = ({
  ...
  const terraformLines = [
    ...
    "    ┌─────────────────────────────────────────────────────────────┐",
    "    │                     📊 MONITORING                           │",
    "    │   ┌─ Prometheus ─┐  ┌─ NewRelic ─┐  ┌─ AlertManager ─┐      │",
    "    │   │      📈      │  │     📉    │  │       🚨       │      │",
    ...
    "    │   📝     🧪     🏗️       🔒        🚀       📊            │",
    "    │                                                             │",
    "    │  GitHub Actions → Docker → Artifactory → GKE → NewRelic     │",
    "    └─────────────────────────────────────────────────────────────┘",
    "",
    "    ┌─────────────────────────────────────────────────────────────┐",
    "    │                     🔐 SECURITY & COMPLIANCE               │",
    ...
    "",
    "Changes to Outputs:",
    '  + cluster_endpoint = "https://k8s.platform.ca"',
    '  + monitoring_url   = "https://grafana.platform.ca"',
    "",
